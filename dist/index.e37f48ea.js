...
var _deleteRecipeViewJs = require("./views/deleteRecipeView.js");
var _deleteRecipeViewJsDefault = parcelHelpers.interopDefault(_deleteRecipeViewJs);
...
var _nutritionViewJs = require("./views/nutritionView.js");
var _nutritionViewJsDefault = parcelHelpers.interopDefault(_nutritionViewJs);
...
const controlSearchResults = async function() {
    try {
        ...
        (0, _resultsViewJsDefault.default).toggleList();
...
const controlAddToShoppingList = function(data, addAll = false) {
    // 1) add ingredients
    if (addAll) _modelJs.addToShoppingList(data, true);
    else _modelJs.addToShoppingList(data);
    // 2) Render shopping list
    (0, _shoppingListViewJsDefault.default).render(_modelJs.state.shoppingList);
};
const controlRemoveFromShoppingList = function(id) {
    // 1) remove ingredient
    _modelJs.removeFromShoppingList(id);
    // 2) Render shopping list
    (0, _shoppingListViewJsDefault.default).render(_modelJs.state.shoppingList);
};
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        }, (0, _configJs.RENDER_FORM_SEC) * 1000);
    } catch (err) {
...
const controlDeleteRecipe = async function() {
    try {
        const id = window.location.hash.slice(1);
        // Show loading spinner
        (0, _deleteRecipeViewJsDefault.default).renderSpinner();
        // Delete the recipe data
        await _modelJs.deleteRecipe(id);
        // Success message
        (0, _deleteRecipeViewJsDefault.default).renderMessage();
        // Remove ID from URL
        setTimeout(()=>{
            window.history.replaceState(null, "", window.location.href.split("#")[0]);
        }, 5);
        // Delete bookmark
        _modelJs.deleteBookmark(id);
        // Render bookmarks
        (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
        // Update results
        _modelJs.deleteResult(id);
        (0, _resultsViewJsDefault.default).renderSpinner();
        (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage());
        (0, _paginationViewJsDefault.default).render(_modelJs.state.search);
        if (_modelJs.state.search.results.length === 0) (0, _resultsViewJsDefault.default)._clear();
    } catch (err) {
        (0, _deleteRecipeViewJsDefault.default).renderError(err.message);
    }
};
const controlSortRecipe = async function(sortBy) {
    try {
        const resultsList = await _modelJs.sortResults();
...
const controlAddRemoveIngredients = function() {
    (0, _addRecipeViewJsDefault.default).addHandlerIngredients();
};
const controlIngredientsNutrients = async function(data) {
    try {
        const ingInfo = await _modelJs.ingredientInfo(data);
        (0, _nutritionViewJsDefault.default).renderWindowSpinner();
        setTimeout(()=>{
            (0, _nutritionViewJsDefault.default).renderNutrients(ingInfo);
        }, 500);
    } catch (err) {
        (0, _nutritionViewJsDefault.default).renderNutrientsError();
    }
};
const controlRecipeCalories = async function(data) {
    try {
        const calories = await _modelJs.recipeCalories(data);
        (0, _recipeViewJsDefault.default).renderCalories(calories);
        (0, _recipeViewJsDefault.default).toggleWindow();
    } catch (err) {
        console.log(err);
    }
};
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerAddToList(controlAddToShoppingList);
    (0, _recipeViewJsDefault.default).addHandlerAddAllToList(controlAddToShoppingList);
    (0, _recipeViewJsDefault.default).addHandlerIngNutrients(controlIngredientsNutrients);
    (0, _recipeViewJsDefault.default).addHandlerRecipeCalories(controlRecipeCalories);
    (0, _searchViewJsDefault.default).addHandlerSearch(controlSearchResults);
    (0, _paginationViewJsDefault.default).addHandlerClick(controlPagination);
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlAddRecipe);
    (0, _addRecipeViewJsDefault.default).addHandlerIngredients(controlAddRemoveIngredients);
    (0, _deleteRecipeViewJsDefault.default).addHandlerDelete(controlDeleteRecipe);
    (0, _resultsViewJsDefault.default).addHandlerSort(controlSortRecipe);
    (0, _shoppingListViewJsDefault.default).addHandlerRender(controlShoppingList);
    (0, _shoppingListViewJsDefault.default).addHandlerRemoveFromList(controlRemoveFromShoppingList);
    (0, _shoppingListViewJsDefault.default).addHandlerClearList(controlClearShoppingList);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./views/deleteRecipeView.js":"cri5I","./views/shoppingListView.js":"eqBFd","./views/nutritionView.js":"bbTu8","regenerator-runtime/runtime":"dXNgZ","./config.js":"k5Hzs","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "removeFromShoppingList", ()=>removeFromShoppingList);
...
parcelHelpers.export(exports, "deleteResult", ()=>deleteResult);
parcelHelpers.export(exports, "sortResults", ()=>sortResults);
parcelHelpers.export(exports, "ingredientInfo", ()=>ingredientInfo);
parcelHelpers.export(exports, "recipeCalories", ()=>recipeCalories);
var _regeneratorRuntime = require("regenerator-runtime");
var _configJs = require("./config.js");
...
const loadRecipe = async function(id, returnValue = true) {
    try {
...
const addToShoppingList = function(ingredientsData, addAll = false) {
    if (addAll) ingredientsData.forEach((ing)=>state.shoppingList.push(ing));
    else state.shoppingList.push(ingredientsData);
    persistShoppingList();
};
const removeFromShoppingList = function(id) {
...
const uploadRecipe = async function(newRecipe) {
    try {
        const quantities = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("Quantity")).map((entry)=>entry[1]);
        const units = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("Unit")).map((entry)=>entry[1]);
        const descriptions = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith("Description")).map((entry)=>entry[1]);
...
const deleteRecipe = async function(id) {
    try {
        const fetchPro = fetch(`${(0, _configJs.API_URL)}${id}?key=${(0, _configJs.KEY)}`, {
            method: "DELETE"
        });
        await fetchPro;
    } catch (err) {
...
const ingredientInfo = async function(ing) {
    try {
        const [data] = await (0, _helpersJs.getIngNutrients)(`${(0, _configJs.SPOONACULAR_URL)}?apiKey=${(0, _configJs.SPOONACULAR_KEY)}&ingredientList=${ing}&includeNutrition=true`);
        return {
            name: data.name,
...
const recipeCalories = async function(ingArr) {
    try {
        const ingDataArr = ingArr.map((ing)=>`${ing.quantity} ${ing.description}`);
        const ingNutritionArr = ingDataArr.map(async (el)=>await ingredientInfo(el));
        const nutritionInfo = await Promise.all(ingNutritionArr);
        const nutrients = nutritionInfo.flatMap((ing)=>ing.nutrients);
        const calories = nutrients.reduce((acc, cur)=>cur.name === "Calories" ? acc + cur.amount : acc, 0);
...
parcelHelpers.export(exports, "SPOONACULAR_URL", ()=>SPOONACULAR_URL);
parcelHelpers.export(exports, "SPOONACULAR_KEY", ()=>SPOONACULAR_KEY);
parcelHelpers.export(exports, "TIMEOUT_SEC", ()=>TIMEOUT_SEC);
parcelHelpers.export(exports, "RES_PER_PAGE", ()=>RES_PER_PAGE);
parcelHelpers.export(exports, "MODAL_CLOSE_SEC", ()=>MODAL_CLOSE_SEC);
parcelHelpers.export(exports, "RENDER_FORM_SEC", ()=>RENDER_FORM_SEC);
const API_URL = "https://forkify-api.herokuapp.com/api/v2/recipes/";
const KEY = "2b56e887-9ee3-4c3f-8d2e-9eb91d8a27f9";
const SPOONACULAR_URL = "https://api.spoonacular.com/recipes/parseIngredients";
const SPOONACULAR_KEY = "8afce0fe645d40158c9986bfe98b52d4";
const TIMEOUT_SEC = 10;
const RES_PER_PAGE = 10;
const MODAL_CLOSE_SEC = 2;
const RENDER_FORM_SEC = 2.01;
...
parcelHelpers.export(exports, "getIngNutrients", ()=>getIngNutrients);
var _regeneratorRuntime = require("regenerator-runtime");
...
const getIngNutrients = async function(url) {
    try {
...
class RecipeView extends (0, _viewsDefault.default) {
    ...
    addHandlerAddAllToList(handler) {
        this._parentElement.addEventListener("click", (function(e) {
            ...
            if (!btn) return;
            const ingArr = Array.from(document.querySelectorAll(".recipe__ingredient"));
    ...
    _getIngData(childrenArr) {
        const [quantity] = childrenArr.filter((el)=>el.classList.contains("recipe__quantity"));
        const [description] = childrenArr.filter((el)=>el.classList.contains("recipe__description"));
        return {
...
},{"./Views":"tgSJX","url:../../img/icons.svg":"loVOp","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"tgSJX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class PaginationView extends (0, _viewsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return `${this._generateMarkupButton("next", curPage)}<p class="page--number">${curPage} / ${numPages}</p>`;
        //  Last page
        if (curPage === numPages && numPages > 1) return `${this._generateMarkupButton("prev", curPage)}<p class="page--number">${curPage} / ${numPages}</p>`;
        // Other page
        if (curPage < numPages) return `${this._generateMarkupButton("next", curPage)}<p class="page--number">${curPage} / ${numPages}</p>${this._generateMarkupButton("prev", curPage)}`;
...
class AddRecipeView extends (0, _viewsDefault.default) {
    ...
    <button class="btn upload__btn">
      <svg>
          <use href="${(0, _iconsSvgDefault.default)}g#icon-upload-cloud"></use>
      </svg>
      <span>Upload</span>
    </button>
    `;
    ...
    _addRemoveIngredient(e) {
        ...
        if (btn.classList.contains("btn--add")) {
          ...
          `;
            document.querySelector(".ingredients--column").insertAdjacentHTML("beforeend", markup);
        }
        if (btn.classList.contains("btn--remove")) {
            const ingredients = Array.from(document.querySelectorAll(".ingredients__info"));
            if (ingredients.length === 1) return;
            const ingredientToRemove = ingredients.find((ing)=>+ing.dataset.num === this._ingredientNumber - 1);
            document.querySelector(".ingredients--column").removeChild(ingredientToRemove);
            --this._ingredientNumber;
        }
    }
    addHandlerIngredients() {
        this._parentElement.addEventListener("click", this._addRemoveIngredient.bind(this));
    }
}
exports.default = new AddRecipeView();

},{"./Views":"tgSJX","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cri5I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _views = require("./Views");
var _viewsDefault = parcelHelpers.interopDefault(_views);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class DeleteRecipeView extends (0, _viewsDefault.default) {
    _parentElement = document.querySelector(".recipe");
...
exports.default = new DeleteRecipeView();

},{"./Views":"tgSJX","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eqBFd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _views = require("./Views");
var _viewsDefault = parcelHelpers.interopDefault(_views);
...
var _fracty = require("fracty");
var _fractyDefault = parcelHelpers.interopDefault(_fracty);
class ShoppingListView extends (0, _viewsDefault.default) {
    _parentElement = document.querySelector(".shopping__list");
    _errorMessage = "No ingredients yet. Find a recipe and add ingredients from it :)";
    _message = "";
    ...
    _generateMarkup() {
        return this._data.map((listItem)=>`
...
},{"./Views":"tgSJX","url:../../img/icons.svg":"loVOp","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bbTu8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _views = require("./Views");
var _viewsDefault = parcelHelpers.interopDefault(_views);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class nutritionView extends (0, _viewsDefault.default) {
    _parentElement = document.querySelector(".recipe");
    ...
    _errorMessage = "We could not find ingredient nutrients. Please try another one :)";
    constructor(){
        super();
        this._addHandlerShowWindow();
        this._addHandlerHideWindow();
    ...
    <div class="nutrients-section">
      ...
      <div class="nutrients--table-box">
        <table class="nutrients--info-table">
          ...
          <tbody>
            ${data.nutrients.map((ing)=>this._generateMarkupNutrition(ing)).join("")}
          </tbody>
        </table>
      </div>
    </div>
...
exports.default = new nutritionView();

},{"./Views":"tgSJX","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aD7Zm","aenu9"], "aenu9", "parcelRequire3a11")
